...
#define STRING_CONFIG_H_AUTHOR "(@mcarne, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Boomer"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "2e1342e7-47f7-4e8d-ac46-2ba212a2fc75"
...
#define PID_AUTOTUNE_MENU // Add PID Autotune to the LCD "Temperature" menu to run M303 and apply the result.
  ...
  // Tronxy X1 values from PID autotune: Start with these values, but replace with your values after your own PID autotune
  // if you make changes to existing setup check EEPROM after flashing new firmware, it might still have the old values.
  #define  DEFAULT_Kp 18.54
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 222 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 4, 1 }
